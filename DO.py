...
def DO(type, iopin, COVIncrement, MaxPresValue, MinPresValue, VarName, Description,offset, ElecTopOfScale, EngBottomOfScale, EngTopOfScale,ThermistorType,ActiveText,InactiveText,newxmlIOfolder):
        
        insert=f'''<OI DESCR="Digital Output {VarName}{Description}" NAME="{VarName}" TYPE="bacnet.mpx.point.DigitalOutput" flags="libExcluded">
